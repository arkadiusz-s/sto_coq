...
Proof.
  ...
  assert (trace_write_version (x2 ++ (tid1, lock_write_item) :: (tid2, read_item (trace_write_version t)) :: t) = trace_write_version t -> ~ In ). admit.
  apply H1 in H16.
  apply in_split in H16. destruct H16. destruct H4.
